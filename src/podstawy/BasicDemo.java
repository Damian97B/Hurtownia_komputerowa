...
//        int testedCluster = 2; //Uatalamy skupienie
//        
//        int sumIndex = 2500; //Numer atrybutu plec (ustalamy atrybut symboliczny dla obliczania statystyki)
...
//            {
//                String locPlec = instance.toString(sumIndex);                
...
//        Instances data2 = BasicTools.loadData("./src/data/hurt_komp_zamowienia5.arff");
